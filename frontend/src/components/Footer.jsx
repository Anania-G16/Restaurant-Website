    ...
    <footer>
      <div className="footer-container">
        ...
        <div className="contact">
          <div>Contact Us</div>
          <div>5 kilo Street, Addis Ababa</div>
          <div>Phone: <a href="tel:+251934567890">+251 934 567 890</a></div>
          <div>
            Email: <a href="mailto:info@yearestaurant.com">info@yearestaurant.com</a>
          </div>
          <div>Mon-Sun: 10:00 AM - 11:00 PM</div>
        </div>
      </div>

      <div className="copyright">© 2025 YEA Restaurant. All rights reserved.</div>
    </footer>
  );
}
